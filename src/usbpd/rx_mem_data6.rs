#[doc = "Register `RX_MEM_DATA6` reader"]
pub struct R(crate::R<RX_MEM_DATA6_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RX_MEM_DATA6_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RX_MEM_DATA6_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RX_MEM_DATA6_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "RX SRAM Data The memory for the RX USB power controller is a 32 byte SRAM. Address map for this Memory is: 0x0050: The Rx Header 0x0054:0x006C: The RX Data Object Any access to address space 0x0050 - 0x006C will map to SRAM address x0-x15\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rx_mem_data6](index.html) module"]
pub struct RX_MEM_DATA6_SPEC;
impl crate::RegisterSpec for RX_MEM_DATA6_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [rx_mem_data6::R](R) reader structure"]
impl crate::Readable for RX_MEM_DATA6_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets RX_MEM_DATA6 to value 0"]
impl crate::Resettable for RX_MEM_DATA6_SPEC {
    #[inline(always)]
