#[doc = "Register `TX_MEM_DATA2` reader"]
pub struct R(crate::R<TX_MEM_DATA2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TX_MEM_DATA2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TX_MEM_DATA2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TX_MEM_DATA2_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TX_MEM_DATA2` writer"]
pub struct W(crate::W<TX_MEM_DATA2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TX_MEM_DATA2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TX_MEM_DATA2_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TX_MEM_DATA2_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "TX SRAM Data The memory for the TX USB power controller is a 32 byte SRAM. Address map for this Memory is: 0x0030: The Tx Header 0x0034:0x004C: The TX Data Object Any access to address space 0x0030 - 0x004C will map to SRAM address x0-x15\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [tx_mem_data2](index.html) module"]
pub struct TX_MEM_DATA2_SPEC;
impl crate::RegisterSpec for TX_MEM_DATA2_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [tx_mem_data2::R](R) reader structure"]
impl crate::Readable for TX_MEM_DATA2_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [tx_mem_data2::W](W) writer structure"]
impl crate::Writable for TX_MEM_DATA2_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets TX_MEM_DATA2 to value 0"]
impl crate::Resettable for TX_MEM_DATA2_SPEC {
    #[inline(always)]
