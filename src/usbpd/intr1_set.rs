#[doc = "Register `INTR1_SET` reader"]
pub struct R(crate::R<INTR1_SET_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<INTR1_SET_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<INTR1_SET_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<INTR1_SET_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `INTR1_SET` writer"]
pub struct W(crate::W<INTR1_SET_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<INTR1_SET_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<INTR1_SET_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<INTR1_SET_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `VCONN1_CHANGED` reader - Write with '1' to set corresponding bit in interrupt request register."]
...
#[doc = "Field `VCONN1_CHANGED` writer - Write with '1' to set corresponding bit in interrupt request register."]
...
#[doc = "Field `VCONN2_CHANGED` reader - Write with '1' to set corresponding bit in interrupt request register."]
...
#[doc = "Field `VCONN2_CHANGED` writer - Write with '1' to set corresponding bit in interrupt request register."]
...
#[doc = "Field `CC1_CHANGED` reader - Write with '1' to set corresponding bit in interrupt request register."]
...
#[doc = "Field `CC1_CHANGED` writer - Write with '1' to set corresponding bit in interrupt request register."]
...
#[doc = "Field `CC2_CHANGED` reader - Write with '1' to set corresponding bit in interrupt request register."]
...
#[doc = "Field `CC2_CHANGED` writer - Write with '1' to set corresponding bit in interrupt request register."]
...
#[doc = "Field `VCMP_LA_CHANGED` reader - Write with '1' to set corresponding bit in interrupt request register."]
...
#[doc = "Field `VCMP_LA_CHANGED` writer - Write with '1' to set corresponding bit in interrupt request register."]
...
#[doc = "Field `VCMP_UP_CHANGED` reader - Write with '1' to set corresponding bit in interrupt request register."]
...
#[doc = "Field `VCMP_UP_CHANGED` writer - Write with '1' to set corresponding bit in interrupt request register."]
...
#[doc = "Field `VCMP_DN_CHANGED` reader - Write with '1' to set corresponding bit in interrupt request register."]
...
#[doc = "Field `VCMP_DN_CHANGED` writer - Write with '1' to set corresponding bit in interrupt request register."]
...
#[doc = "INTR1 Set\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [intr1_set](index.html) module"]
pub struct INTR1_SET_SPEC;
impl crate::RegisterSpec for INTR1_SET_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [intr1_set::R](R) reader structure"]
impl crate::Readable for INTR1_SET_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [intr1_set::W](W) writer structure"]
impl crate::Writable for INTR1_SET_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets INTR1_SET to value 0"]
impl crate::Resettable for INTR1_SET_SPEC {
    #[inline(always)]
