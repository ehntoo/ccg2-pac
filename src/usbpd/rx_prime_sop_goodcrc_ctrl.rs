#[doc = "Register `RX_PRIME_SOP_GOODCRC_CTRL` reader"]
pub struct R(crate::R<RX_PRIME_SOP_GOODCRC_CTRL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RX_PRIME_SOP_GOODCRC_CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RX_PRIME_SOP_GOODCRC_CTRL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RX_PRIME_SOP_GOODCRC_CTRL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `RX_PRIME_SOP_GOODCRC_CTRL` writer"]
pub struct W(crate::W<RX_PRIME_SOP_GOODCRC_CTRL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<RX_PRIME_SOP_GOODCRC_CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<RX_PRIME_SOP_GOODCRC_CTRL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<RX_PRIME_SOP_GOODCRC_CTRL_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "`read()` method returns [rx_prime_sop_goodcrc_ctrl::R](R) reader structure"]
impl crate::Readable for RX_PRIME_SOP_GOODCRC_CTRL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [rx_prime_sop_goodcrc_ctrl::W](W) writer structure"]
impl crate::Writable for RX_PRIME_SOP_GOODCRC_CTRL_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets RX_PRIME_SOP_GOODCRC_CTRL to value 0"]
impl crate::Resettable for RX_PRIME_SOP_GOODCRC_CTRL_SPEC {
    #[inline(always)]
