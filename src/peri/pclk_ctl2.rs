#[doc = "Register `PCLK_CTL2` reader"]
pub struct R(crate::R<PCLK_CTL2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PCLK_CTL2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PCLK_CTL2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PCLK_CTL2_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PCLK_CTL2` writer"]
pub struct W(crate::W<PCLK_CTL2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PCLK_CTL2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PCLK_CTL2_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PCLK_CTL2_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "`read()` method returns [pclk_ctl2::R](R) reader structure"]
impl crate::Readable for PCLK_CTL2_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pclk_ctl2::W](W) writer structure"]
impl crate::Writable for PCLK_CTL2_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PCLK_CTL2 to value 0xc3"]
impl crate::Resettable for PCLK_CTL2_SPEC {
    #[inline(always)]
