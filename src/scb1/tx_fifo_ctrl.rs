...
#[doc = "Field `TRIGGER_LEVEL` reader - Trigger level. When the transmitter FIFO has less entries than the number of this field, a transmitter trigger event is generated."]
...
#[doc = "Field `TRIGGER_LEVEL` writer - Trigger level. When the transmitter FIFO has less entries than the number of this field, a transmitter trigger event is generated."]
...
impl R {
    #[doc = "Bits 0:3 - Trigger level. When the transmitter FIFO has less entries than the number of this field, a transmitter trigger event is generated."]
    #[inline(always)]
