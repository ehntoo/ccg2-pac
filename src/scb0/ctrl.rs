...
#[doc = "Mode of operation (3: Reserved)\n\nValue on reset: 3"]
...
#[doc = "Field `MODE` reader - Mode of operation (3: Reserved)"]
...
#[doc = "Field `MODE` writer - Mode of operation (3: Reserved)"]
pub struct MODE_W<'a> {
    w: &'a mut W,
}
impl<'a> MODE_W<'a> {
...
impl R {
    ...
    #[doc = "Bits 24:25 - Mode of operation (3: Reserved)"]
    #[inline(always)]
