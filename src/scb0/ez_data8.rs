#[doc = "Register `EZ_DATA8` reader"]
pub struct R(crate::R<EZ_DATA8_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<EZ_DATA8_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<EZ_DATA8_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<EZ_DATA8_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `EZ_DATA8` writer"]
pub struct W(crate::W<EZ_DATA8_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<EZ_DATA8_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<EZ_DATA8_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<EZ_DATA8_SPEC>) -> Self {
        W(writer)
    }
}
