...
impl HFCLK_SEL_R {
    ...
    pub(crate) fn new(bits: u8) -> Self {
        HFCLK_SEL_R(crate::FieldReader::new(bits))
    }
...
impl core::ops::Deref for HFCLK_SEL_R {
    type Target = crate::FieldReader<u8, HFCLK_SEL_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl<'a> HFCLK_SEL_W<'a> {
    ...
    #[inline(always)]
    pub fn variant(self, variant: HFCLK_SEL_A) -> &'a mut W {
...
impl HFCLK_DIV_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        HFCLK_DIV_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for HFCLK_DIV_R {
    type Target = crate::FieldReader<u8, HFCLK_DIV_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl<'a> HFCLK_DIV_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: HFCLK_DIV_A) -> &'a mut W {
...
impl core::ops::Deref for PUMP_SEL_R {
    type Target = crate::FieldReader<u8, PUMP_SEL_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl<'a> PUMP_SEL_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: PUMP_SEL_A) -> &'a mut W {
        unsafe { self.bits(variant.into()) }
    }
    #[doc = "`0`"]
    #[inline(always)]
...
impl core::ops::Deref for SYSCLK_DIV_R {
    type Target = crate::FieldReader<u8, SYSCLK_DIV_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl<'a> SYSCLK_DIV_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: SYSCLK_DIV_A) -> &'a mut W {
        self.bits(variant.into())
    }
    #[doc = "`0`"]
    #[inline(always)]
